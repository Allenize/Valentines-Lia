    ...
    document.getElementById("startButton").addEventListener("click", function () {
        ...
        content.innerHTML = `
            <div class="envelope-wrapper">
                <div id="envelope" class="close">
                    ...
                    <div class="letter">
                        <p class="words line1">I'm so lucky to have you in my life Lia:D</p>
                        <p class="words line2">Thank you for being the most beautiful part of my life. No matter what happens, I </p>
                        <p class="words line3">promise to always care for you, support you, and choose you again and again.</p>
                        <p class="words line4">- your Linne ily</p>
                    </div>
                </div>
            </div>
            <div class="continue">
            ...
            <style>
                ...
                .envelope-wrapper {
                    height: 500px; /* increased from 380px to accommodate larger envelope */
                }

                #envelope {
                    position: relative;
                    height: 270px;   /* 180px * 1.5 */
                    width: 420px;     /* 280px * 1.5 */
                    border-bottom-left-radius: 9px;  /* scaled slightly */
                    border-bottom-right-radius: 9px;
                    margin-left: auto;
                    margin-right: auto;
                    top: 50%;
                    background-color:rgb(128, 255, 99);
                ...
                .flap {
                    border-top: 147px solid rgb(73, 201, 99);    /* 98px * 1.5 */
                    border-left: 210px solid transparent;        /* 140px * 1.5 */
                    border-right: 210px solid transparent;       /* 140px * 1.5 */
                    border-bottom: 123px solid transparent;      /* 82px * 1.5 */
                    transform-origin: top;
                }

                .pocket {
                    border-left: 210px solid rgb(139, 255, 154);  /* 140px * 1.5 */
                    border-right: 210px solid rgb(139, 255, 154); /* 140px * 1.5 */
                    border-bottom: 135px solid rgb(139, 255, 154); /* 90px * 1.5 */
                    border-top: 135px solid transparent;          /* 90px * 1.5 */
                ...
                .open .letter {
                    transform: translatey(-120px);  /* adjusted for larger envelope */
        ...
        btnContinue.addEventListener("click", function () {
            content.innerHTML = `
                ...
                <div class="question">
                    <p style="font-size: 24px;">Pindutin mo nalang kasi yung "Yes"</p>
            ...
            // "No" button enlarges the Yes button (no sad message)
